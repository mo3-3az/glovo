...
class OrderComparatorTest {
    ...
    void sortOrdersPrioritizedByDistanceVIPFood() {
        ...
        ordersPriorityStrategy.setLocation(Location.get(41.1, 2.101));
        ...
        final List<Order> ordersOriginal = Arrays.asList(
                new Order().withPickup(Location.get(43.1, 2.101)).withVip(true).withFood(false),
                new Order().withPickup(Location.get(41.1, 2.101)).withVip(true).withFood(false),
                new Order().withPickup(Location.get(41.1, 2.101)).withVip(true).withFood(true),
                new Order().withPickup(Location.get(42.1, 2.101)).withVip(false).withFood(false)
        );
    ...
    void sortOrdersPrioritizedByFoodDistanceVIP() {
        ...
        final List<Order> ordersOriginal = Arrays.asList(
                ...
                new Order().withPickup(Location.get(41.1, 2.101)).withVip(true).withFood(false),
                new Order().withPickup(Location.get(41.1, 2.101)).withVip(true).withFood(true),
                new Order().withPickup(Location.get(42.1, 2.101)).withVip(false).withFood(true)
        );
    ...
    void sortOrdersPrioritizedByVIPFoodDistance() {
        ...
        final List<Order> ordersOriginal = Arrays.asList(
                new Order().withPickup(Location.get(41.1, 2.101)).withVip(true).withFood(false),
                new Order().withPickup(Location.get(43.1, 2.101)).withVip(true).withFood(false),
                new Order().withPickup(Location.get(41.1, 2.101)).withVip(false).withFood(false),
                new Order().withPickup(Location.get(42.1, 2.101)).withVip(false).withFood(false),
                new Order().withPickup(Location.get(41.1, 2.101)).withVip(true).withFood(true),
                new Order().withPickup(Location.get(42.1, 2.101)).withVip(false).withFood(true)
        );
